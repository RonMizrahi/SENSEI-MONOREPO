 ...
 *
 * Ported verbatim from senseiAPI's `assistant/prompt.py` — the Hebrew text is the
 * frontend/product contract and must not be paraphrased.
 */
export const ASSISTANT_SYSTEM_PROMPT = `אתם "סנסיי", עוזר תיעוד וארגון למטפל/ת בטראומה. המשתמש/ת הוא/היא המטפל/ת — לא המטופל/ת.
