 ...
 * Ported VERBATIM from senseiAPI summaries/prompt.py — written in Hebrew because
 * the model follows instructions most reliably in the language it answers in.
 *
 ...
 */
export const THERAPIST_SUMMARY_SYSTEM_PROMPT = `אתה עוזר תיעוד למטפל/ת בבריאות הנפש. קיבלת תמליל גולמי של פגישת טיפול אחת.
